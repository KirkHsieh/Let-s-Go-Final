...
INSERT INTO `user` (`user_id`, `name`, `counrty`, `language`, `email`, `personality`, `hobby`, `introduction`, `privacy`, `photo`, `level`) VALUES
('2418897468135824', '蔡冠玗', '', '', '', '', '', '', NULL, '', 3);
